defmodule FortuneCookie do
  @moduledoc """
  A mysterious device with sensitivities to the energies of its user.
  """
  ...
  require Integer
  defdelegate roll(sides), to: FortuneCookie.Dice
  ...
  ## Examples
      ...
      iex> FortuneCookie.fortune()
      "All progress occurs because people dare to be different.",
  """
  def fortune do
    Enum.random(@fortunes)
  end
